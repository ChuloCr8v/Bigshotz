...
const Hero = () => {
  ...
  return(
    <main className="hero min-h-screen flex justify-center  items-center w-screen overflow-hidden relative">
      ...
      className=""
        ...
        <SwiperSlide > 
            <img src={heroImg.urls.regular} key={index} className ="min-h-screen object-cover" alt="Paul Ray Photography" /> 
        </SwiperSlide> 
          ))} 
      </Swiper>
      <style jsx>{` 
